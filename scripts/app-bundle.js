define('resources/elements/wrapper',["require", "exports"], function (require, exports) {
    "use strict";
...
define('resources/elements/prompt',["require", "exports", 'aurelia-framework', 'aurelia-dialog'], function (require, exports, aurelia_framework_1, aurelia_dialog_1) {
    "use strict";
    var Prompt = (function () {
        function Prompt(controller) {
            this.controller = controller;
        }
        Prompt.prototype.activate = function (data) {
            this.outer = data.outer;
        };
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Object)
        ], Prompt.prototype, "outer", void 0);
        Prompt = __decorate([
...
define('app',["require", "exports", 'aurelia-framework', './resources/elements/prompt', 'aurelia-dialog'], function (require, exports, aurelia_framework_1, prompt_1, aurelia_dialog_1) {
    "use strict";
    var App = (function () {
        function App(dialogService) {
            ...
            setTimeout(function () {
                _this.outer = JSON.parse('{ "name":"replaced", "inner":[{"name":"replaced 1"},{"name":"replaced 2"}]}');
            }, 3000);
        }
        App.prototype.openPrompt = function () {
            return this.dialogService.open({ viewModel: prompt_1.Prompt, model: this });
        };
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Object)
        ], App.prototype, "outer", void 0);
        App = __decorate([
            aurelia_framework_1.autoinject, 
...
define('resources/elements/bar',["require", "exports", 'aurelia-framework'], function (require, exports, aurelia_framework_1) {
    "use strict";
    var Bar = (function () {
        function Bar() {
        }
        Bar.prototype.activate = function (data) {
            this.outer = data;
        };
        Bar.prototype.outerChanged = function () {
            console.log('outerChanged from bar');
        };
        __decorate([
            aurelia_framework_1.bindable, 
            __metadata('design:type', Object)
        ], Bar.prototype, "outer", void 0);
        return Bar;
    }());
    exports.Bar = Bar;
});

define('resources/elements/slotted',["require", "exports"], function (require, exports) {
    "use strict";
    var Slotted = (function () {
        function Slotted() {
        }
        return Slotted;
    }());
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <button click.delegate=\"openPrompt()\">open dialog</button><br><br> \n  \n   (app [inline]) inner data:<br>\n  <div repeat.for=\"s of outer.inner\">${s.name}</div>\n</template>"; });
define('text!resources/elements/bar.html', ['module'], function(module) { module.exports = "<template>\r\n  (bar [component]) inner data:<br>\r\n  <div repeat.for=\"s of outer.inner\">${s.name}</div> \r\n</template>"; });
define('text!resources/elements/prompt.html', ['module'], function(module) { module.exports = "<template>\r\n  <ai-dialog>\r\n    <ai-dialog-body>\r\n        <div repeat.for=\"i of outer.inner\">${i.name}</div>\r\n    </ai-dialog-body>\r\n\r\n    <ai-dialog-footer>\r\n    <button click.trigger=\"controller.cancel()\">Cancel</button>\r\n    </ai-dialog-footer>\r\n  </ai-dialog>\r\n</template>"; });
define('text!resources/elements/slotted.html', ['module'], function(module) { module.exports = "<template>\r\n    The first slot:\r\n    <slot name=\"s1\">\r\n      foo\r\n    </slot>\r\n    <slot name=\"s2\"></slot>\r\n    ?\r\n</template>"; });
